...
<html lang="en">
  <head>
    ...
    <title>Task Manager | Complaint Details</title>
...
<?php } ?>
 ...
 <div class="row mt">
   ...
   <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Assigned Employee </label>
              <div class="col-sm-10">
              <p><?php echo htmlentities($row['assigned_emp']);?></p>
              </div>
