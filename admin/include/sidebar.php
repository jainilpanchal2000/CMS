...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="register_e.php"><i class="menu-icon icon-tasks"></i>Register Employee</a></li>
                                <li><a href="manage-emp.php"><i class="menu-icon icon-tasks"></i>Employee List</a></li>                          
