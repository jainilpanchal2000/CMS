...
include('include/config.php');
  ...
  $db = mysqli_connect('localhost', 'root', '', 'cms');
   $result=mysqli_query( $db,"SELECT fullName , area_of_exp FROM employee");
...
$sql2=mysqli_query($con,"update tblcomplaints set assigned_emp='$assigned_emp' where complaintNumber='$complaintnumber'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <option value="closed">Closed</option>
      ...
      <tr height="50">
      <td><b>Assigned Employee</b></td>
      <td><select name="assigned_emp" required="required">
      <?php
